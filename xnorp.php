...
<h1>Seleccione los pesos Pesos Iniciales</h1>
   ...
   <tr>
       <td class="pesotd1"><input type="text" class="peso1"  id="peso1"></p></td>
...
<h1>Tabla de verdad NOR</h1>
   ...
   <tr>
       ...
       <td>0</td>
       <td>1</td>
       <td><input type="submit" value=">>" onclick="enviodatosnor1()"></input></td>
   </tr>
   <tr>
       <td>0</td>
       <td>1</td>
       <td>0</td>
       <td><input type="submit" value=">>"   onclick="enviodatosnor2()"></input></td>
   </tr>
   <tr>
       <td>1</td>
       <td>0</td>
       ...
       <td><input type="submit" value=">>"  onclick="enviodatosnor3()"></input></td>
   </tr>
   <tr>
       <td>1</td>
       <td>1</td>
       <td>0</td>
       <td><input type="submit" value=">>"  onclick="enviodatosnor4()"></input></td>
   </tr>
</table>
<h2>Valor de Σ</h2>
