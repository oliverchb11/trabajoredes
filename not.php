...
<div class="orl">
<img src="compuertas/NOT.png" alt="NOT">
</div>
<div class="or">
    <img src="compuertas/not1.png" alt="NOT">
</div>
<script>
       ...
       function enviodatos1(){
        ...
        document.getElementById("d").innerHTML = variabledesalida ;
           ...
           var sumatoriapesos =  (parseInt(x1) * parseFloat(nw1)) +  (parseInt(valordeagregado) * parseFloat(ntheta)) ;
